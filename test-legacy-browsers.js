...
// 创建一个文本刺激
let textStim = new window.PsychoJS.visual.TextStim({
    win: psychoJS.window,
    text: '你好，PsychoJS！',
...
function introductions_1RoutineBegin(snapshot) {
  return async function () {
    ...
    introductions_1Components.forEach( function(thisComponent) {
...
function apple0RoutineBegin(snapshot) {
  return async function () {
    ...
    apple0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function apple1RoutineBegin(snapshot) {
  return async function () {
    ...
    apple1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function xiaomi1RoutineBegin(snapshot) {
  return async function () {
    ...
    xiaomi1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_xiaomi0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_xiaomi0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function introductions_2RoutineBegin(snapshot) {
  return async function () {
    ...
    introductions_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_zhuoziRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_zhuoziComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_qingshu0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_qingshu0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_caoyuanRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_caoyuanComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_heimei0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_heimei0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_weicheng1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_weicheng1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_hongniu0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_hongniu0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_shirenRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_shirenComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_hongqi1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_hongqi1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_diannaoRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_diannaoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_qingshu1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_qingshu1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_niunaiRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_niunaiComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_baoma1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_baoma1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_jiaofu0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_jiaofu0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_yintian0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_yintian0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_chaguan0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_chaguan0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_shuyeRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_shuyeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_baixiang0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_baixiang0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_sinian1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_sinian1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_chengshiRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_chengshiComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_sinian0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_sinian0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_xiaoshuoRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_xiaoshuoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_fuqin0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_fuqin0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_guangming1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_guangming1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_baimao0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_baimao0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_xiongdi1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_xiongdi1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_lianxiang1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_lianxiang1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_chaguan1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_chaguan1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_mifanRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_mifanComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_baimao1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_baimao1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_yanjingRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_yanjingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_tiankongRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_tiankongComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_luotuo1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_luotuo1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_fuqin1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_fuqin1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_luotuo0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_luotuo0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_weicheng0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_weicheng0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_chuanghuRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_chuanghuComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_mutouRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_mutouComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_jiemeiRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_jiemeiComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_huahai1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_huahai1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_lixiang0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_lixiang0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_heimei1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_heimei1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_yintian1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_yintian1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_danche0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_danche0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_baoma0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_baoma0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_huahai0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_huahai0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_lixiang1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_lixiang1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_beiying0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_beiying0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_lianxiang0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_lianxiang0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_gongfu1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_gongfu1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_miantiaoRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_miantiaoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_heimaoRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_heimaoComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_beiying1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_beiying1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_danche1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_danche1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_dianyingRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_dianyingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_shitouRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_shitouComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_xiongdi0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_xiongdi0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_senlinRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_senlinComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_hongqi0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_hongqi0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_shenhai0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_shenhai0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_feihe0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_feihe0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_shenhai1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_shenhai1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_shoujiRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_shoujiComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_hongniu1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_hongniu1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_guangming0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_guangming0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_qicheRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_qicheComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_gongfu0RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_gongfu0Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_yusanRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_yusanComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_jiaofu1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_jiaofu1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_baixiang1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_baixiang1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_canguanRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_canguanComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_feihe1RoutineBegin(snapshot) {
  return async function () {
    ...
    trial_feihe1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
